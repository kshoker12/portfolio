                    ...
                    <a href={`#${nav.id}`}>
                        <li 
                            ...
                            className = {`inline-flex items-center px-1 pr-1 pb-2 font-bold text-md leading-5 transition duration-150 ease-in-out focus:outline-none ${
                                active === nav.title ? 'border-b-[3px] border-purple-400 text-white focus:border-purple-400 hover:text-purple-200' : 'transition-underline border-transparent text-gray-100 hover:text-purple-100 focus:text-purple-100'
                            }`}
